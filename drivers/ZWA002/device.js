...
class ZWA002Device extends ZwaveDevice {
  ...
  onMeshInit() {
    ...
    let strobeOnFlow = new Homey.FlowCardAction('BULB6MC-strobe_on');
    strobeOnFlow
        .register()
        .registerRunListener(( args, state ) => {
          ...
          if (args.hasOwnProperty('speed') && args.speed !== '') {
            ...
            newSettings.config_param_3 = args.speed;
            changedKeysArr.push('config_param_3');
          }

          //Random color
          if (args.hasOwnProperty('random_color') && args.random_color !== '') {
            oldSettings.config_param_1 = args.device.getSetting('config_param_1');
            newSettings.config_param_1 = args.random_color;
            changedKeysArr.push('config_param_1');
          }

          //Number of strobes
          if (args.hasOwnProperty('count') && args.count !== '') {
            oldSettings.config_param_4 = args.device.getSetting('config_param_4');
            newSettings.config_param_4 = args.count;
            changedKeysArr.push('config_param_4');
          }
		  
		  //Strobe blink
          if (args.hasOwnProperty('strobe') && args.strobe !== '') {
            oldSettings.config_param_2 = args.device.getSetting('config_param_2');
            newSettings.config_param_2 = args.strobe;
    ...
    let strobeOffFlow = new Homey.FlowCardAction('BULB6MC-strobe_off');
    strobeOffFlow
        .register()
        .registerRunListener(( args, state ) => {
          return args.device.onSettings({config_param_1:1},{config_param_1:0},['config_param_1']);
		  return args.device.onSettings({config_param_1:2},{config_param_1:0},['config_param_1']);
